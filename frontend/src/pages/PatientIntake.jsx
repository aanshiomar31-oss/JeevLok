...
import SymptomNLPInput from "../components/nlp/SymptomNLPInput.jsx";
import ClinicalSummaryCard from "../components/summary/ClinicalSummaryCard.jsx";
...
export default function PatientIntake() {
  ...
  function handleAutoFill(payload) {
    setForm((prev) => {
      const updated = { ...prev };
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        {/* Clinical NLP & Voice Intake Hub */}
        <SymptomNLPInput onApplyAutoFill={handleAutoFill} />
        ...
        <div className="panel p-6">
          ...
          {submitted?.triggered_protocols?.length > 0 && !showProtocols && (
            ...
            {displayed && (
              <div className="mt-4">
                <ClinicalSummaryCard
                  patientData={buildPayload(form)}
                  triageResult={displayed}
                />
              </div>
            )}
          </div>
